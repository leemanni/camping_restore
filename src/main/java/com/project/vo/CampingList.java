...
//	pageSize, totalCount, currentPage를 인수로 넘겨받아 페이지 작업에 사용할 8개의 변수를 초기화하는 메소드
	...
	public ArrayList<CampingVO> getList() {
		return list;
	}

	public void setList(ArrayList<CampingVO> list) {
		this.list = list;
	}
