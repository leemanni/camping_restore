...
<section class="login-block">
  ...
  <div class="form-group">
    <label for="exampleInputPassword1" class="text-uppercase">비밀번호 확인</label>
    <input type="password" class="form-control" placeholder="">
  </div>
    ...
    <button type="submit" class="btn btn-login float-right">회원가입</button>
  </div>
  
</form>
<div class="copy-text"><a href="./loginMain">로그인</a></div>
		</div>
